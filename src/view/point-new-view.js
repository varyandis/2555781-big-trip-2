...
const createNewPointTemplate = (point, offerList, destinationList) => {
  const {basePrice, dateFrom, dateTo, destination, id, type, offers, isDisabled, isSaving} = point;
    ...
    <form class="event event--edit" action="#" method="post">
                <header class="event__header">
                  ...
                  <div class="event__field-group  event__field-group--price">
                    ...
                    <input class="event__input  event__input--price" id="event-price-${id}" type="text" name="event-price" value="${(!basePrice) ? '' : basePrice}" type="number" ${isDisabled ? 'disabled' : ''}>
                  </div>
                   <button class="event__save-btn  btn  btn--blue" type="submit">${isSaving ? 'Saving...' : 'Save'}</button><button class="event__reset-btn" type="reset">Cancel</button>
                </header>
...
export default class NewPointView extends AbstractStatefulView {
  ...
  constructor({point, offers, destination, onFormSubmit, onDeleteClick}) {
    super();
    this._setState(NewPointView.parsePointToState(point, destination));
    this.#offers = offers;
  ...
  #formSubmitHandler = (evt) => {
    evt.preventDefault();
    this.#handleFormSubmit(NewPointView.parseStateToPoint(this._state, this.#destination));
  };
